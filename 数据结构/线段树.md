...
![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142414.png)
...
![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142432.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142523.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142537.png)
...
![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142630.png)
...
![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142644.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142655.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142704.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142716.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142725.png)
...
![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142735.png)

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142745.png)

注：为什么是加上 $1\times 1=1$ 呢？因为 B 和 C 表示的区间中只有 $1$ 个元素。

![img](https://raw.githubusercontent.com/SheldonZi/image-host/master/img/20210719142754.png)
 ...
 *
 * @author :zixiaotong
 * @date :Created in 2021/7/20 13:50
 */
public class SegmentTree {
    ...
    public static SegmentTree buildTree(int[] arr) {
        SegmentTree segmentTree = new SegmentTree(arr);
        segmentTree.build(0, arr.length - 1, 1);
        return segmentTree;
    }
    ...
    private void update(int l, int r, int c, int s, int t, int p) {
        // 当前区间为待修改区间的子集，直接修改当前结点的值，然后打标记
        if (l <= s && t <= r) {
            d[p] += (t - s + 1) * c;
            b[p] += c;
            return;
     ...
     * @param p
     */
    private void pushDown(int s, int m, int t, int p) {
        // 左子结点
        d[p * 2] += b[p] * (m - s + 1);
        b[p * 2] += b[p];
        // 右子结点 t - (m + 1) + 1 == t - m
...
[查看原文](https://oi-wiki.org/ds/seg/)

## 相关资料

[wikipedia](https://en.wikipedia.org/wiki/Segment_tree)

[线段树数组开2N还是4N？](https://zhuanlan.zhihu.com/p/65943900)

[Java实现](https://www.cnblogs.com/sunliyuan/p/10720167.html)

[Java实现2](https://www.cnblogs.com/reminis/p/12652184.html)

[Java实现3](https://zhangchenzuo.github.io/2020/10/29/%E3%80%90%E4%B8%93%E9%A2%98%E8%AE%B2%E8%A7%A3%E3%80%91%E7%BA%BF%E6%AE%B5%E6%A0%91/)

[Java实现4](https://last2win.com/2020/01/28/LeetCode-307-Range-Sum-Query-Mutable-Java/)
